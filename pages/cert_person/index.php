<?php session_start(); ?>
  ...
  <html>
    <head>
      ...
      ?>
      <link rel="stylesheet" href="css/cert_person.css">
    </head>
    <body class="hold-transition skin-blue sidebar-mini" onload="showProcessbar();showSlidebar();">
      <div class="wrapper">
        ...
        <div class="content-wrapper">
          ...
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-dashboard"></i> Cert_person</a></li>
            ...
            <div class="row">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">cert_person Controller</h3>

                  <!-- <div class="box-tools pull-right">
                    <button onclick="showForm('ADD')" class="btn btn-success btn-flat pull-right">ADD cert_person</button>
                  </div> -->
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title" id="myModalLabel">cert_person Module</h4>
                    </div>
      ...
      <script src="js/cert_person.js"></script>
    </body>
  </html>
