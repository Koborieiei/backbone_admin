...
@$skill_name = $_GET['skill_name']==null?"Pre-Test":$_GET['skill_name'];
          ...
          <section class="content">
           ...
           <!-- Tabs -->
            ...
            <div class="row">
              <!-- Left col -->
              <div class="col-md-4">
                <div class="box " style="min-height: 58vh;">
                  <div class="box-header with-border">
                    <h3 class="box-title">Card skills</h3>
                    <div class="center-div">
                  <h4>ขนาดที่แนะนำ 286px*180px</h4>
                </div>
                  ...
                  <!-- /.box-header -->
                  <div class="box-body">
                    <form action="ajax/AEDModule.php" class="dropzone" id="dropzoneFrom" enctype="multipart/form-data">
              ...
              <div class="col-md-8">
                ...
                <div class="box ">
                  <div class="box-header with-border">
                    <h3 class="box-title" id="textCardseleced"> <?=$skill_name?> Card Data </h3>
                  </div>
                  <!-- /.box-header -->
                  <div class="box-body">
