<?php session_start(); ?>
  ...
  <html>
    <head>
      ...
      ?>
      <link rel="stylesheet" href="css/STD_skill.css">
    </head>
    <body class="hold-transition skin-blue sidebar-mini" onload="showProcessbar();showSlidebar();">
      <div class="wrapper">
        ...
        <div class="content-wrapper">
          ...
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-dashboard"></i> Standard skills</a></li>
            ...
            <div class="row">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Standard skills Controller</h3>

                  <!-- <div class="box-tools pull-right">
                    <button onclick="showForm('ADD')" class="btn btn-success btn-flat pull-right">ADD STD_skill</button>
                  </div> -->
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title" id="myModalLabel">Standard skills Module</h4>
                    </div>
      ...
      <script src="js/STD_skill.js"></script>
    </body>
  </html>
